...
$(function () {
	...
	*				Initial State
	*************************************************/
    //alert('setThemeSettings()');
	//themeSettings['footerPosition'] = 'footer-fixed';   
	setThemeSettings();
	...
	*************************************************/
	...
	function setThemeState() {
		...
		if (themeSettings.themeName) {
			$styleLink.attr('href', 'Content/app-' + themeSettings.themeName + '.css');
		}
		else {
		    $styleLink.attr('href', 'Content/app.css');
		}
